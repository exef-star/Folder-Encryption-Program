...
class FolderEncryptor(ttk.Window):
    def __init__(self):
        ...
        self.title("文件夹加密程序&By HantaFrog | 庆祝中华人民共和国成立七十五周年")
    ...
    def create_widgets(self):
        ...
        #在右上角添加版本号
        self.version_label = ttk.Label(self, text="庆祝中华人民共和国成立七十五周年！", font=("consolas", 10), foreground="red", anchor=ttk.NW)
        self.version_label.place(x=636, y=26.5)
...
print("success run the program")
print("庆祝中华人民共和国成立七十五周年！")
>>>>>>> 61c3f0508c080041b63010e8f522cd03006eb8b1
