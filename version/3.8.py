...
class FolderEncryptor(ttk.Window):
    ...
    def help(self):
        answer = messagebox.askyesno("跳转确认", "在3.8版本，作者已经在压缩包里内置了帮助文档的html文件\n是否要跳转到帮助文档？")
        if answer:
    ...
    def update_log(self):
        messagebox.showinfo("更新日志", "版本号：v3.8\n\n更新内容：\n1. 添加了更新日志、素材声明等按钮（在关于菜单）2. 优化代码结构\n3.改了一下标题字体")
